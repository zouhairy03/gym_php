...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateStmt->execute()) {
        header("Location: members_women.php");
        exit();
    } else {
...
<head>
    ...
    <title>Edit Woman Member - <?php echo htmlspecialchars($member['first_name'] . ' ' . $member['last_name']); ?></title>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <h2>Edit Woman Member - <?php echo htmlspecialchars($member['first_name'] . ' ' . $member['last_name']); ?></h2>
            
            <?php if (isset($error_message)): ?>
                <div class="alert alert-danger"><?php echo $error_message; ?></div>
            <?php endif; ?>

            <form action="edit_woman.php?id=<?php echo $member_id; ?>" method="POST" enctype="multipart/form-data">
