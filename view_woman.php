...
<head>
    ...
    <title>View Woman - <?php echo htmlspecialchars($member['first_name'] . ' ' . $member['last_name']); ?></title>
...
<div class="wrapper">
    ...
    <div class="profile-container" style="text-align: center;">
        ...
        <!-- Back Button -->
        <a href="members_women.php" class="btn btn-secondary mt-3">Back to Members</a>
    </div>
