...
$query = "SELECT member_id, first_name, last_name, gender, picture, phone_number, CNE, activity_status, insurance_status, membership_status, created_at 
          FROM members WHERE gender = 'female'";
...
$totalQuery = "SELECT COUNT(*) as total FROM members WHERE gender = 'female'";
...
<div class="wrapper">
    ...
    <button class="btn btn-secondary mb-3" id="toggleSidebar">Toggle Sidebar</button>
        ...
        <!-- Search and Filter -->
        <form method="GET" action="members_women.php">
        ...
        <div class="table-responsive">
            <table class="table table-hover ">
                ...
                <tbody id="membersTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group actions">
                                    <a href="edit_woman.php?id=<?php echo $row['member_id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                    <a href="view_woman.php?id=<?php echo $row['member_id']; ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> View</a>
                                    <a href="delete_woman.php?id=<?php echo $row['member_id']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Delete</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="10" class="text-center">No women members found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<script>
    ...
    document.getElementById('exportExcel').addEventListener('click', function () {
        window.location.href = 'export_women_excel.php'; // Trigger export by navigating to the export script
    });
</script>
