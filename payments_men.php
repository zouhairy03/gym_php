...
// Query for fetching men's payments
...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment;filename="men_payments.xlsx"');
        ...
        <div class="table-responsive">
            <table class="table table-hover ">
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="view_men_payment.php?id=<?php echo $row['payment_id']; ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                        <a href="edit__men_payment.php?id=<?php echo $row['payment_id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <a href="delete_men_payment.php?id=<?php echo $row['payment_id']; ?>" class="btn btn-danger btn-sm" ><i class="fas fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center">No payments found for men.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<div class="modal fade" id="addPaymentModal" tabindex="-1" aria-labelledby="addPaymentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addPaymentForm" action="add_payment_men.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="memberSelect" name="member_id" required>
                            ...
                            <?php
                            // Fetch active male members
                            $member_sql = "SELECT member_id, first_name, last_name 
                                           FROM members 
                                           WHERE gender = 'male' AND activity_status = 'active'";
