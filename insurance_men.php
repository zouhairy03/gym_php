...
// Base query for filtering men with insurance
$where_clause = "WHERE members.gender = 'male'";
...
// Query for fetching men's insurance records
...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment;filename="men_insurance.xlsx"');
...
<div class="wrapper">
    ...
    <div class="content" id="content">
        ...
        <h2 class="mt-4 text-center" style="background:lightblue ;color: white;"><i class="fas fa-shield-alt"></i> Men's Insurance</h2>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="view_men_insurance.php?id=<?php echo $row['insurance_id']; ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                        <a href="edit_men_insurance.php?id=<?php echo $row['insurance_id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <a href="delete_men_insurance.php?id=<?php echo $row['insurance_id']; ?>" class="btn btn-danger btn-sm" ><i class="fas fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
...
<div class="modal fade" id="addInsuranceModal" tabindex="-1" aria-labelledby="addInsuranceModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="add_insurance_men.php" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="memberSelect" name="member_id" required>
                            ...
                            <?php
                            $member_sql = "SELECT member_id, first_name, last_name FROM members WHERE gender = 'male' AND activity_status = 'active'";
