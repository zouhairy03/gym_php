...
$where_clause = "WHERE members.gender = 'female' AND (members.first_name LIKE '%$search%' OR members.last_name LIKE '%$search%')";
...
// Fetch pending payments for female members with search functionality and date filters
$pending_sql = "
...
<script>
    ...
    $('#deleteModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = type === 'membership' ? 'delete_women_notif.php?id=' + id : 'delete_women_pay.php?id=' + id;
