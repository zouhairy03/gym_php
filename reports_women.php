...
// KPIs
$total_payments_query = "SELECT COUNT(*) as total FROM payments JOIN members ON payments.member_id = members.member_id WHERE members.gender = 'female' $date_filter";
$total_amount_query = "SELECT COALESCE(SUM(amount_paid), 0) as total FROM payments JOIN members ON payments.member_id = members.member_id WHERE members.gender = 'female' $date_filter";
$average_payment_query = "SELECT COALESCE(AVG(amount_paid), 0) as average FROM payments JOIN members ON payments.member_id = members.member_id WHERE members.gender = 'female' $date_filter";
$paid_payments_query = "SELECT COUNT(*) as total FROM payments JOIN members ON payments.member_id = members.member_id WHERE members.gender = 'female' AND pending_amount = 0 $date_filter";
$unpaid_payments_query = "SELECT COUNT(*) as total FROM payments JOIN members ON payments.member_id = members.member_id WHERE members.gender = 'female' AND pending_amount > 0 $date_filter";

// Total Users by Gender and Filtered Date
$total_users_query = "SELECT COUNT(*) as total FROM members WHERE gender = 'female' $date_filter";
$total_memberships_query = "SELECT COUNT(*) as total FROM memberships JOIN members ON memberships.member_id = members.member_id WHERE members.gender = 'female' $date_filter";
...
$top_members_query = "SELECT members.first_name, members.last_name, SUM(payments.amount_paid) as total_paid 
                      ...
                      WHERE members.gender = 'female' $date_filter
...
$total_users_by_month_query = "
    ...
    FROM members
    WHERE gender = 'female' $date_filter
    GROUP BY month
    ORDER BY month DESC
    LIMIT 12";
...
<div class="content">
    ...
    <h2 class="dashboard-header" style="text-align: center;background: pink;color: white;">
        <i class="fas fa-female"></i> Women's Reports
