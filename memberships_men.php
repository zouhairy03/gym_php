...
// Base query for filtering male members
...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment;filename="male_memberships.xlsx"');
                    ...
                    <?php else: ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="edit_membership_men.php?id=<?php echo $row['membership_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="view_membership_men.php?id=<?php echo $row['membership_id']; ?>" class="btn btn-info"><i class="fas fa-eye"></i> View</a>
                                        <a href="delete_membership_men.php?id=<?php echo $row['membership_id']; ?>" class="btn btn-danger" ><i class="fas fa-trash"></i> Delete</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
...
<div class="modal fade" id="addMembershipModal" tabindex="-1" aria-labelledby="addMembershipModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addMembershipForm" action="add_membership_men.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="memberSelect" name="member_id" required>
                            ...
                            <!-- Populate with active male members from database -->
                            <?php
...
<script>
    ...
    $(document).ready(function() {
        $('#memberSelect').change(function() {
            ...
            if (member_id != '') {
                $.ajax({
                    url: 'get_member_details_men.php', method: 'POST',
