...
if (!isset($_GET['id'])) {
    ...
    header("Location: memberships_women.php");
    exit();
}
...
$sql = "SELECT memberships.*, members.first_name, members.last_name, members.phone_number, members.picture 
        ...
        WHERE memberships.membership_id = ? AND members.gender = 'female'";
...
<head>
    ...
    <title>Edit Membership - Women</title>
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                <a href="memberships_women.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Cancel</a>
            </form>
        </div>
    </div>
</div>
