...
if (isset($_POST['member_id'])) {
    ...
    $sql = "SELECT first_name, last_name, phone_number, picture FROM members WHERE member_id = ? AND gender = 'men' AND activity_status = 'active'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo json_encode(['error' => 'No active men member found']);
    }
