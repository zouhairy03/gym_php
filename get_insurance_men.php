...
$query = "SELECT i.insurance_id, i.insurance_start_date, i.insurance_expiry_date, i.price, 
          ...
          WHERE m.member_id = ? AND m.gender = 'male'";
...
if ($result->num_rows > 0) {
    ...
    // Prepare image path
    $imagePath = "uploads/members/men/" . $insuranceData['member_id'] . ".jpg";
    $insuranceData['picture'] = file_exists($imagePath) ? $imagePath : "uploads/members/men/default.jpg";
